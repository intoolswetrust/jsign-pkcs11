...
//            }
    ...
    private static final class P11Service extends Service {
        ...
        public boolean supportsParameter(Object param) {
            ...
            throw new AssertionError
                ("JSignPKCS11 error: " + type + ", " + algorithm);
        }
    ...
    /**
     * Serialized representation of the JSignPKCS11 provider.
     */
    private static class JSignPKCS11Rep implements Serializable {
        ...
        JSignPKCS11Rep(JSignPKCS11 provider) throws NotSerializableException {
            ...
            if (Security.getProvider(providerName) != provider) {
                throw new NotSerializableException("Only JSignPKCS11 providers "
                    + "installed in java.security.Security can be serialized");
            }
        }

        private Object readResolve() throws ObjectStreamException {
            JSignPKCS11 p = (JSignPKCS11)Security.getProvider(providerName);
